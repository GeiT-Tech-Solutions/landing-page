    ...
    return (
        <Container>
            <Row className="row-section-end">
                ...
                <p>We work hard on using cutting-edge method and process to satisfy our customer demand</p>
            </Row>
            ...
            <Row className="row-section-content-end">
                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <p className="card-text section-end-content">
                                ...
                                Gather detailed requirements from customers through interviews and surveys.
                                Analyze the real-life situation to identify issues and improvement opportunities.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-3">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <h4 className="section-end-title">Solution Analysis and Fit Gap Assessment</h4>
                            <p className="card-text  section-end-content">
                                Analyze customer requirements and current status.
                                Assess the fit-gap between the software solution and user needs.
                                Report the current status, propose suitable solutions, and evaluate benefits.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-3">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <h4 className="section-end-title">Solution Consultation and Planning</h4>
                            <p className="card-text  section-end-content">
                                Provide detailed consultation on the ERP solution that matches the customer's needs and current status.
                                Develop a detailed implementation plan, including costs and timelines.
                                Present the plan to the customer, address any questions, and make adjustments if necessary.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-3">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <h4 className="section-end-title">Implementation and Data Gathering</h4>
                            <p className="card-text  section-end-content">
                                Implement the ERP system according to the discussed plan.
                                Install, train users, migrate data, and provide deployment support.
                                Collect and analyze data from real-life operations to evaluate the solution's effectiveness.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <Row className="row-section-detail-end">
                    <div className="col-6">
                        ...
                        <div className="col m-8">
                            <div className="col d-flex align-items-center">
                                ...
                                <p className="row-section-detail-end-para">beautiful visual effects</p>
                            </div>
                            <div className="col d-flex align-items-center">
                                <img src={maketing1} className="row-section-detail-end-icon" />
                                <p className="row-section-detail-end-para">Marketing efficiently</p>
                            </div>
                            <div className="col d-flex align-items-center">
                                <img src={maketing3} className="row-section-detail-end-icon" />
                                <p className="row-section-detail-end-para">Customer information gather</p>
                            </div>
                    ...
                    <div className="col-6">
                        ...
                        <div className="col d-flex align-items-center">
                            ...
                            <p className="row-section-detail-end-para">human resources management (HRM)</p>
                        </div>

                        <div className="col d-flex align-items-center">
                            <img src={FM} className="row-section-detail-end-icon" />
                            <p className="row-section-detail-end-para">financial management (FM)</p>
                        </div>

                        <div className="col d-flex align-items-center">
                            <img src={IM} className="row-section-detail-end-icon" />
                            <p className="row-section-detail-end-para">inventory management (IM)</p>
                        </div>

                        <div className="col d-flex align-items-center">
                            <img src={CRM} className="row-section-detail-end-icon" />
                            <p className="row-section-detail-end-para">customer relationship management (CRM)</p>
                        </div>

                        <div className="col d-flex align-items-center">
                            <img src={MRP} className="row-section-detail-end-icon" />
                            <p className="row-section-detail-end-para">Manufacturing resource planning (MRP)</p>
                        </div>

                        <div className="col d-flex align-items-center">
                            <img src={SCM} className="row-section-detail-end-icon" />
                            <p className="row-section-detail-end-para">supply chain management (SCM)</p>
                        </div>

                        <div className="col d-flex align-items-center">
                            <img src={PM} className="row-section-detail-end-icon" />
                            <p className="row-section-detail-end-para">Project management (PM)</p>
                        </div>

                        <div className="col d-flex align-items-center">
                            <img src={BI} className="row-section-detail-end-icon" />
                            <p className="row-section-detail-end-para">business intelligence (BI)</p>
                        </div>

                        <div className="col d-flex align-items-center">
                            <img src={CM} className="row-section-detail-end-icon" />
                            <p className="row-section-detail-end-para">compliance management (CM)</p>
                        </div>

                        <div className="col d-flex align-items-center">
                            <img src={ecommerce} className="row-section-detail-end-icon" />
                            <p className="row-section-detail-end-para">e-Commerce integration (ECI)</p>
                        </div>
                ...
                <Row className="row-section-detail-end">
                    <div className="col-6">
                        ...
                        <div className="col m-8">
                            <div className="col d-flex align-items-center">
                                <img src={ecommerce} className="row-section-detail-end-icon" />
                                <p className="row-section-detail-end-para">Online selling point</p>
                            </div>
